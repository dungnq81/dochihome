            ...
            protected function get_settings_for_style_section() {
                ...
                $settings = array(
                    ...
                    array(
                        ...
                        'type'  => 'title',
                        'title' => esc_html__( 'Archive Page Swatches Style', 'woo-variation-swatches' ),
                        'desc'  => esc_html__( 'Change swatches style on archive page', 'woo-variation-swatches' ),
                    ),
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Width', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Archive/Shop page variation item width. Default is: 30', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 30,
                        'suffix'            => 'px',
                        'custom_attributes' => array(
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Height', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Archive/Shop page variation item height. Default is: 30', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 30,
                        'suffix'            => 'px',
                        'custom_attributes' => array(
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Font Size', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Archive/Shop page variation item font size. Default is: 16', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 16,
                        'suffix'            => 'px',
                        'custom_attributes' => array(
                    ...
                    array(
                        ...
                        'type'  => 'title',
                        'title' => esc_html__( 'Tooltip Styling', 'woo-variation-swatches' ),
                        'desc'  => esc_html__( 'Change tooltip styles', 'woo-variation-swatches' )
                    ),
                    
                    array(
                        'id'                => 'tooltip_background_color',
                        'type'              => 'color',
                        'title'             => esc_html__( 'Tooltip background', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Tooltip background color. Default is: #333333', 'woo-variation-swatches' ),
                        'css'               => 'width: 6em;',
                        'default'           => '#333333',
                        'custom_attributes' => array(//    'data-alpha-enabled' => 'true'
                        )
                    ...
                    array(
                        ...
                        'type'    => 'color',
                        'title'   => esc_html__( 'Tooltip text color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Tooltip text color. Default is: #FFFFFF', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#FFFFFF',
                    ),
                    ...
                    array(
                        ...
                        'type'    => 'select',
                        'title'   => esc_html__( 'Tooltip image size', 'woo-variation-swatches' ),
                    ...
                    array(
                        ...
                        'type'  => 'title',
                        'title' => esc_html__( 'Variation Item Styling', 'woo-variation-swatches' ),
                        'desc'  => esc_html__( 'Change variation item display style', 'woo-variation-swatches' ),
                    ),
                    
                    array(
                        'id'      => 'border_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Border color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item border color. Default is: #a8a8a8', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#a8a8a8',
                    ),
                    ...
                    array(
                        'id'                => 'border_size',
                        'type'              => 'number',
                        'title'             => esc_html__( 'Border size', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Variation item border size. Default is: 1', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 1,
                        'suffix'            => 'px',
                        'custom_attributes' => array(
                    ...
                    array(
                        'id'      => 'background_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Background color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item background color. Default is: #FFFFFF', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#FFFFFF',
                    ),
                    ...
                    array(
                        'id'      => 'text_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Text color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item text color. Default is: #000000', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#000000',
                    ),
                    ...
                    array(
                        ...
                        'type'  => 'title',
                        'title' => esc_html__( 'Variation Item Hover Styling', 'woo-variation-swatches' ),
                        'desc'  => esc_html__( 'Change variation item hover display style', 'woo-variation-swatches' ),
                    ),
                    
                    array(
                        'id'      => 'hover_border_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Hover border color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item hover border color. Default is: #000000', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#000000',
                    ),
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Hover border size', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Variation item hover border size. Default is: 3', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 3,
                        'suffix'            => esc_html__( 'px', 'woo-variation-swatches' ),
                        'custom_attributes' => array(
                            'min'  => 1,
                            'max'  => 5,
                            'step' => 1,
                    ...
                    array(
                        'id'      => 'hover_text_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Hover text color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item hover text color. Default is: #000000', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#000000',
                    ),
                    ...
                    array(
                        ...
                        'type'    => 'color',
                        'title'   => esc_html__( 'Hover background color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item hover background color. Default is: #FFFFFF', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#FFFFFF',
                    ),
                    ...
                    array(
                        ...
                        'type'  => 'title',
                        'title' => esc_html__( 'Variation Item Selected Styling', 'woo-variation-swatches' ),
                        'desc'  => esc_html__( 'Change variation selected item display style', 'woo-variation-swatches' ),
                    ),
                    
                    array(
                        'id'      => 'selected_border_color',
                        'type'    => 'color',
                        'title'   => esc_html__( 'Selected border color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item selected border color. Default is: #000000', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#000000',
                    ),
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Selected border size', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Variation item selected border size. Default is: 2', 'woo-variation-swatches' ),
                        'css'               => 'width: 60px;',
                        'default'           => 2,
                        'suffix'            => esc_html__( 'px', 'woo-variation-swatches' ),
                        'custom_attributes' => array(
                    ...
                    array(
                        ...
                        'type'    => 'color',
                        'title'   => esc_html__( 'Selected text color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item selected text color. Default is: #000000', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#000000',
                    ),
                    ...
                    array(
                        ...
                        'type'    => 'color',
                        'title'   => esc_html__( 'Selected background color', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Variation item selected background color. Default is: #FFFFFF', 'woo-variation-swatches' ),
                        'css'     => 'width: 6em;',
                        'default' => '#FFFFFF',
                    ),
            ...
            protected function get_settings_for_single_section() {
                $settings = array(
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Minimum stock threshold', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'When stock reaches this amount stock label will be shown.', 'woo-variation-swatches' ),
                        'css'               => 'width: 50px;',
                        'default'           => '5',
                        'custom_attributes' => array(
                            'min'  => 1,
            ...
            protected function get_settings_for_archive_section() {
                $settings = array(
                    ...
                    array(
                        ...
                        'type'    => 'text',
                        'title'   => esc_html__( 'Product wrapper', 'woo-variation-swatches' ),
                        'desc'    => sprintf( __( 'Archive product wrapper selector, You can also use multiple selectors separated by comma (,). Default: %s.', 'woo-variation-swatches' ), '<code>.wvs-archive-product-wrapper</code>' ),
                        //'desc_tip' => true,
                    ...
                    array(
                        ...
                        'type'    => 'text',
                        'title'   => esc_html__( 'Image selector', 'woo-variation-swatches' ),
                        'desc'    => sprintf( __( 'Archive product image selector to show variation image. You can also use multiple selectors separated by comma (,). Default: %s.', 'woo-variation-swatches' ), '<code>.wvs-archive-product-image</code>' ),
                        //'desc_tip' => true,
                    ...
                    array(
                        ...
                        'type'    => 'text',
                        'title'   => esc_html__( 'Add to cart button selector', 'woo-variation-swatches' ),
                        'desc'    => sprintf( __( 'Archive add to cart button selector. Default should be: %s', 'woo-variation-swatches' ), '<code>.wvs-add-to-cart-button</code>' ),
                        //'desc_tip' => true,
                    ...
                    array(
                        ...
                        'desc'    => esc_html__( 'Show clear link on archive / shop page.', 'woo-variation-swatches' ),
                        'default' => 'yes'
                    ),
            ...
            protected function get_settings_for_special_section() {
                $settings = array(
                    ...
                    array(
                        ...
                        'type'     => 'select',
                        // 'size'     => 'tiny',
                        'title'    => esc_html__( 'Choose Attribute', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Choose an attribute to show on catalog mode', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => '',
                    ...
                    array(
                        ...
                        'type'     => 'select',
                        // 'size'    => 'tiny',
                        'title'    => esc_html__( 'Catalog Mode Image Preview', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Show catalog mode image', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => 'click',
                        'options'  => array(
                            'click' => esc_html__( 'on Click', 'woo-variation-swatches' ),
                            'hover' => esc_html__( 'on Hover', 'woo-variation-swatches' ),
                        ),
                        // 'require' => array( 'enable_catalog_mode' => array( 'type' => '!empty' ) )
                        'require'  => $this->normalize_required_attribute( array( 'enable_catalog_mode' => array( 'type' => '!empty' ) ) ),
                    ),
                    ...
                    array(
                        ...
                        'type'    => 'checkbox',
                        'title'   => esc_html__( 'Linkable Attribute', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Keep attribute variation selected on product page after clicking from shop / archive page', 'woo-variation-swatches' ),
                        'default' => 'no',
                    ...
                    array(
                        ...
                        // 'size'    => 'tiny',
                        'title'             => esc_html__( 'Attribute display limit', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Catalog mode attribute display limit. Default is 0. Means no limit.', 'woo-variation-swatches' ),
                        'desc_tip'          => true,
                        'css'               => 'width: 50px;',
                        'default'           => '0',
                    ...
                    array(
                        ...
                        'type'     => 'select',
                        // 'size'    => 'tiny',
                        'title'    => esc_html__( 'Catalog More Link Behaviour', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Catalog More Link Behaviour', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => 'navigate',
                        'options'  => array(
                            'expand'   => esc_html__( 'Expand More Item', 'woo-variation-swatches' ),
                            'navigate' => esc_html__( 'Navigate to Product Page', 'woo-variation-swatches' ),
                        ),
                        // 'require' => array( 'enable_catalog_mode' => array( 'type' => '!empty' ) )
                        'require'  => $this->normalize_required_attribute( array(
                                                                               'enable_catalog_mode'        => array( 'type' => '!empty' ),
                    ...
                    array(
                        ...
                        'type'     => 'select',
                        'title'    => esc_html__( 'Choose Attribute', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Choose an attribute to show variation image', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => '',
                    ...
                    /*array(
                        ...
                        'type'     => 'select',
                        'title'    => esc_html__( 'Fire JS Event', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Fire Variation JS event on variation preview. Default is: "When Variation Shown"', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => 'show_variation',
                        'options'  => array(
                            'show_variation'  => esc_html__( 'When Variation Shown', 'woo-variation-swatches' ),
                            'found_variation' => esc_html__( 'When Variation Found', 'woo-variation-swatches' )
                        ),
                        'require'  => $this->normalize_required_attribute( array( 'enable_single_variation_preview' => array( 'type' => '!empty' ) ) ),
                    ),*/
                    ...
                    array(
                        ...
                        'type'    => 'checkbox',
                        'title'   => esc_html__( 'Preview on Shop Page', 'woo-variation-swatches' ),
                        'desc'    => esc_html__( 'Enable single variation image preview on shop / archive page. Won\'t active when Catalog mode enabled.', 'woo-variation-swatches' ),
                        'default' => 'no',
                        'require' => $this->normalize_required_attribute( array( 'enable_single_variation_preview' => array( 'type' => '!empty' ) ) ),
                    ),
                    ...
                    array(
                        ...
                        // 'size'    => 'tiny',
                        'title'    => esc_html__( 'Choose Attribute', 'woo-variation-swatches' ),
                        'desc'     => esc_html__( 'Choose an attribute to make it large', 'woo-variation-swatches' ),
                        'desc_tip' => true,
                        'css'      => 'width: 200px;',
                        'default'  => '',
                        'options'  => $this->get_taxonomies(),
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Width', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Large variation item width', 'woo-variation-swatches' ),
                        'desc_tip'          => true,
                        'css'               => 'width: 60px;',
                        'default'           => 40,
                        'suffix'            => 'px',
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Height', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Large variation item height', 'woo-variation-swatches' ),
                        'desc_tip'          => true,
                        'css'               => 'width: 60px;',
                        'default'           => 40,
                        'suffix'            => 'px',
                    ...
                    array(
                        ...
                        'type'              => 'number',
                        'title'             => esc_html__( 'Font Size', 'woo-variation-swatches' ),
                        'desc'              => esc_html__( 'Large variation font size', 'woo-variation-swatches' ),
                        'desc_tip'          => true,
                        'css'               => 'width: 60px;',
                        'default'           => 16,
                        'suffix'            => 'px',
