...
Add a quick view button in the product loop so that visitors can quickly view product information in a nice modal without opening the product page.
...
> Ask us at [__Support__](https://shapedplugin.com/support/)
...
[youtube https://www.youtube.com/watch?v=fXW5nzxBP6k]
...
For documentation and tutorials go to our [__Documentation__](https://docs.shapedplugin.com/docs/woocommerce-quick-view-pro/overview/).
...
= 2.0.6 - Jul 14, 2022 =
* Tested: WordPress 6.7.0 compatibility.
