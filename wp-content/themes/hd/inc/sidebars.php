...
if ( ! function_exists( '__register_sidebars' ) ) {
	...
	function __register_sidebars() {
		...
		register_sidebar(
			[
				'container'     => false,
				'id'            => 'w-header-left-sidebar',
				'name'          => __( 'Left Header', 'hd' ),
				'description'   => __( 'Widgets added here will appear in left header.', 'hd' ),
				'before_widget' => '<div class="header-widgets %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<span>',
				'after_title'   => '</span>',
        ...
        register_sidebar(
            [
                'container'     => false,
                'id'            => 'w-header-right-sidebar',
                'name'          => __( 'Right Header', 'hd' ),
