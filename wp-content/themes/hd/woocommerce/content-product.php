...
<article <?php wc_product_class('item', $product); ?>>
    ...
    ?>
    <a rel="follow" class="d-block _blank" href="<?= get_permalink() ?>" aria-label="<?php the_title_attribute() ?>" tabindex="0">
        <div class="cover">
    ...
    <div class="cover-content">
        ...
        ?>
        <h6><a rel="follow" class="_blank" title="<?php the_title_attribute() ?>" href="<?= $link ?>"><?php echo get_the_title(); ?></a></h6>
        <?php
